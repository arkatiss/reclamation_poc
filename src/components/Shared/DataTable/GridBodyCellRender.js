...
export const GridBodyRenderer = ({ handleIconClick, field, rowData, storeIndex, index, editingRowIndex, renderEditableField, handleRulesDef, exploded, activeButtonTemplate, getStoreDetails, getCustomerFeeDetails, checkBoxes, getSelection, getexclusionValidation, getEffectiveDate, getSelectionInput, getMasterUPCDetails, getCustAndVendorFees, ruleLink, showItemPurchaseStatus, getVendorCustomerDebitCreditDetails, getIsRecallAndSwell, getActionClear, getCheckBoxValueMap, getVendorProfileView, selectAction, getSelectionList, showFileNameLink, showStatusDownload,getRulesDefAuditIcon, showExclusion, screenFeatures,divisionInfoView, showErrorLink, lastUPDDateAudit, explodedRulesRule, dateFormatChange, getCustomerFeeDetailsRule, hazLockCheckboxes,statusChange }) => {
    // if (editingRowIndex === index) {
    //     return renderEditableField(field, rowData, index);
    // }
